    ...
    \begin{tabular}{lll}
	  ...
	  $\inferrule* [left=\bf{SOut}]{
	    ...
	    \underline{\overline{x_{1}}y_{1}}.\ldots.\underline{\overline{x_{n}}y_{n}}.\overline{x}y.P 
	      \xrightarrow{\overline{x_{1}}y_{1} \cdot \ldots \cdot \overline{x_{n}}y_{n} \cdot \overline{x}y} 
		P
	  }$
	&
	  $\inferrule* [left=\bf{EInp}]{
...
\begin{lemma}\label{earlyBisimulationProprerties}
  ...
  \begin{proof}
    ...
    \begin{description}
      \item[Output prefixing]
	The relation $\{(\overline{x}y.P, \overline{x}y.Q): P\sim_{E} Q\} \cup \sim_{E}$ is a strong early bisimulation.
      \item[Strong output prefixing]
	The relation $\{(\underline{\overline{x}y}.P, \underline{\overline{x}y}.Q): P\sim_{E} Q\} \cup \sim_{E}$ is a strong early bisimulation: there are two cases to consider:
	\begin{itemize}
	  \item 
	...
	\end{itemize}
      \item[Tau prefixing]
	The relation $\{(\tau.P, \tau.Q): P\sim_{E} Q\} \cup \sim_{E}$ is a strong early bisimulation.
      \item[Sum]
	The relation $\{(P+R, Q+R): P\sim_{E} Q\} \cup \sim_{E}$ is a strong early bisimulation.
      \item[Restriction]
	The relation $\{((\nu x)P, (\nu x)Q): P\sim_{E} Q\} \cup \sim_{E}$ is a strong early bisimulation.
      \item[Parallel composition]
...
\begin{definition}\label{strongDequivalence}
  $P$ and $Q$ are \emph{strongly D equivalent}, written $P \sim^{D} Q$, if for all substitution $\sigma$ respecting $D$: $P\sigma \sim_{E} Q\sigma$.
\end{definition}
 
 
\begin{lemma}\label{openBisimulationEquivalence}
...
\begin{lemma}\label{openBisimulationPreservedByRestriction}
...
\begin{lemma}\label{openBisimulationPreservedByInput}
...
\begin{lemma}\label{openBisimulationPreservedByAllExceptInput}
      If $P \sim^{D} Q$ then 
      \begin{itemize}
	\item 
	  $\tau.P \sim^{D} \tau.Q$
...
\begin{theorem}
  ...
  \begin{proof}
    Lemma \ref{openBisimulationEquivalence} and put $D=\emptyset$ in lemma \ref{openBisimulationPreservedByAllExceptInput} and in lemma \ref{openBisimulationPreservedByInput}
  \end{proof}
\end{theorem}
