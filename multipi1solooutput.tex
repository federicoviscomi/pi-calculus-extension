...
% All the possible instantiation of the rule $LCom$ are the following:
% \begin{center}
%   \begin{tabular}{l|lll}
% 	
%       &
% 	$Q_{1}\; \xrightarrow{x(y)}\; Q_{2}$
%       &
% 	$Q_{1}\; \xrightarrow{\overline{x}z}\; Q_{2}$	
%       &
% 	$Q_{1}\; \xrightarrow{\overline{x}z\cdot \sigma}\; Q_{2}$	
%     \\\hline
% 	$P_{1}\; \xrightarrow{x(y)}\; P_{2}$	
%       &
% 	no sync
%       &
% 	$Sync(x(y), \overline{x}z, \tau)$
%       &
% 	$Sync(x(y), \overline{x}z\cdot \sigma, \sigma)$
%     \\
% 	$P_{1}\; \xrightarrow{\overline{x}z}\; P_{2}$
%       &
% 	$Sync(\overline{x}z, x(y), \tau)$
%       &
% 	no sync
%       &
% 	no sync
