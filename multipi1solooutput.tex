...
% 	    w \notin (fn(P)-\{z\})
	...
	&
	  $\gamma$ is a non empty sequence of outputs
      \\
    \end{tabular}
      \\
    \begin{tabular}{ll}
...
\begin{proposition}
  ...
  \begin{proof}
	...
	The relation $\{(\overline{x}y.P, \overline{x}y.Q): P\dot{\sim}_{E} Q\} \cup \dot{\sim}_{E}$ is a strong early bisimulation.
      \item[Strong output prefixing]
	The relation $\{(\underline{\overline{x}y}.P, \underline{\overline{x}y}.Q): P\dot{\sim}_{E} Q\} \cup \dot{\sim}_{E}$ is a strong early bisimulation: there are two cases to consider:
	\begin{itemize}
	  \item 
	    ...
	    \end{center}
	    $P \xrightarrow{\gamma} P^{'}$ and $P \dot{\sim}_{E} Q$ imply $Q \xrightarrow{\gamma} Q^{'}$ and $P^{'} \dot{\sim}_{E} Q^{'}$. For rule $SOut$: $\underline{\overline{x}y}.Q \xrightarrow{\overline{x}y \cdot \gamma} Q^{'}$ so the conclusion holds.
	  \item
...
\begin{example}
  $\dot{\sim}_{E}$ is not in general preserved by input prefixing because:
    \begin{center}
      $a(x).0 | \overline{b}y.0 \dot{\sim}_{E} a(x).\overline{b}y.0 + \overline{b}y.a(x).0$
    \end{center}
    but 
    \begin{center}
...
\begin{definition}
  A \emph{distinction} is a finite symmetric and irreflexive binary relation on names. A substitution $\sigma$ \emph{respects} a distinction $D$ if 
  \begin{center}
...
\begin{definition}\label{strongDequivalence}
  $P$ and $Q$ are \emph{strongly D equivalent}, written $P \dot{\sim}^{D} Q$, if for all substitution $\sigma$ respecting $D$: $P\sigma \dot{\sim}_{E} Q\sigma$.
\end{definition}
 
 
\begin{theorem}
  $\dot{\sim}^{D}$ is a congruence.
  \begin{proof}
    $\dot{\sim}^{D}$ is an equivalence relation because $\dot{\sim}_{E}$ is an equivalence relation.
    \begin{description}
      \item[$Reflexivity$]
	Since $\dot{\sim}_{E}$ is reflexive, for all substitution $\sigma$ respecting $D$: $P\sigma \dot{\sim}_{E} Q\sigma$ so $P \dot{\sim}^{D} P$
      \item[$Symmetry$]
	Let $P \dot{\sim}^{D} Q$ then for all substitution $\sigma$ respecting $D$: $P\sigma \dot{\sim}_{E} Q\sigma$. Since $\dot{\sim}_{E}$ is symmetric $Q\sigma \dot{\sim}_{E} P\sigma$ so $Q \dot{\sim}^{D} P$
      \item[$Transitivity$]
	Let $P \dot{\sim}^{D} Q$ and $Q \dot{\sim}^{D} R$ then for all substitution $\sigma$ respecting $D$: $P\sigma \dot{\sim}_{E} Q\sigma$ and $Q\sigma \dot{\sim}_{E} R\sigma$. Since $\dot{\sim}_{E}$ is transitive $P\sigma \dot{\sim}_{E} R\sigma$ so $P \dot{\sim}^{D} R$.
    \end{description}
    $\dot{\sim}^{D}$ is preserved by every operator. Let $P \dot{\sim}^{D} Q$ and let $\sigma$ be a substitution respecting $D$ so $P\sigma \dot{\sim}_{E} Q\sigma$:
    \begin{description}
      \item[Output prefixing]
	The only transitions starting from $(\overline{x}y.P)\sigma$ and $(\overline{x}y.Q)\sigma$ are
	\begin{center}
	      $(\overline{x}y.P)\sigma \xrightarrow{(\overline{x}y)\sigma} P\sigma \dot{\sim}_{E} Q\sigma \xleftarrow{(\overline{x}y)\sigma} (\overline{x}y.Q)\sigma$
	\end{center}
	so $(\overline{x}y.P)\sigma \dot{\sim}_{E} (\overline{x}y.Q)\sigma$ and $\overline{x}y.P \dot{\sim}^{D} \overline{x}y.Q$
      \item[Strong output prefixing]
	There are two cases to consider:
	\begin{itemize}
	  \item 
	    If there exists a transition $P\sigma \xrightarrow{\gamma} P^{'}$ where $\gamma$ is a non empty sequence of outputs then
	    \begin{center}
	      $\inferrule* [left=\bf{SOut}]{
		P\sigma \xrightarrow{\gamma} P^{'}
	      }{
		(\underline{\overline{x}y}.P)\sigma \xrightarrow{(\overline{x}y)\sigma \cdot \gamma} P^{'}
	      }$
	    \end{center}
	    $P\sigma \xrightarrow{\gamma} P^{'}$ and $P\sigma \dot{\sim}_{E} Q\sigma$ imply $Q\sigma \xrightarrow{\gamma} Q^{'}$ and $P^{'} \dot{\sim}_{E} Q^{'}$. For rule $SOut$ 
	    \begin{center}
	      $(\underline{\overline{x}y}.Q)\sigma \xrightarrow{(\overline{x}y)\sigma \cdot \gamma} Q^{'}$
	    \end{center}
	    so $(\underline{\overline{x}y}.P)\sigma \dot{\sim}_{E} (\underline{\overline{x}y}.Q)\sigma$ and $\underline{\overline{x}y}.P \dot{\sim}^{D} \underline{\overline{x}y}.Q$.
	  \item
	    Otherwise there is no transition starting from $(\underline{\overline{x}y}.P)\sigma$ or from $(\underline{\overline{x}y}.Q)\sigma$ so $(\underline{\overline{x}y}.P)\sigma$ $\dot{\sim}_{E}$ $(\underline{\overline{x}y}.Q)\sigma$ and  $\underline{\overline{x}y}.P \dot{\sim}^{D} \underline{\overline{x}y}.Q$.
	\end{itemize}
      \item[Input prefixing]
	Let $z\notin bn(P)\cup bn(Q)$ and let $y \notin img(\sigma)$. The transitions starting from $(x(y).P)\sigma$ and $(x(y).Q)\sigma$ are
	\begin{center}
	  \begin{tabular}{ll}
	    $x\sigma (y).P\sigma \xrightarrow{x\sigma z} P\sigma\{z/y\}$ 
	  &
	    $x\sigma (y).Q\sigma \xrightarrow{x\sigma z} Q\sigma\{z/y\}$ 
	  \end{tabular}
	\end{center}
	?
      \item[Tau prefixing]
