...
% 	  }$
  ...
  \begin{center}
	...
	| T$
  \end{center}
  This transition is not what we want because now the scope of the inner $\nu x$ hides in $P$ the scope of the outer $\nu x$, so $P$ and $S$ cannot use $x$ to communicate. But whit the rules of table \ref{MultiOutScopeExtrusionRules} the following transition can be inferred:
  \begin{center}
