...
%       \item[EInp]:
% 	$x(y).P_{1}\xrightarrow{xz} P_{1}\{z/y\}$. $x(y).P_{1} \equiv_{\alpha} Q$ and the inversion lemma for $\alpha$ equivalence imply $Q$ is $x(w).Q_{1}$ and one of the following cases hold:
% 	\begin{itemize}
% 	 \item 
% 	  $P_{1}\equiv_{\alpha}Q_{1}\{y/w\}$ for a process $Q_{1}$ and a name $w$ which is not necessarily different from $y$. Rule $EInp$ proves $x(w).Q_{1} \xrightarrow{xz} Q_{1}\{z/w\}$. $P_{1}\equiv_{\alpha}Q_{1}\{y/w\}$ imply $P_{1}\{z/y\} \equiv_{\alpha}Q_{1}\{y/w\}\{z/y\}$ which in turn imply $P_{1}\{z/y\} \equiv_{\alpha}Q_{1}\{z/w\}$.
% 	\item
% 	  $P_{1}\{w/y\}\equiv_{\alpha}Q_{1}$: this case is similar.
% 	\end{itemize}
...
% 	\begin{center}
% 	  $\inferrule* [left=\bf{Opn}]{
% 	      P_{1} \xrightarrow{\sigma} P_{1}^{'}
% 	    \\
% 	      y \in obj(\sigma)
% 	    \\
% 	      y \notin sbj(\sigma)
% 	  }{
% 	    (\nu y)P_{1} \xrightarrow{opn(\sigma, y)} P_{1}^{'}
% 	  }$
% 	\end{center}
% 	$(\nu y).P_{1} \equiv_{\alpha} Q$ and the inversion lemma for $\alpha$ equivalence imply $Q$ is $(\nu w).Q_{1}$ and one of the following cases hold:
% 	\begin{itemize}
% 	 \item 
% 	  $P_{1}\equiv_{\alpha}Q_{1}\{y/w\}$ for a process $Q_{1}$ and a name $w$ which is not necessarily different from $y$. For inductive hypothesis $Q_{1}\{y/w\} \xrightarrow{\sigma} Q_{1}^{'}$ and $Q_{1}^{'}\equiv_{\alpha} P_{1}^{'}$. Rule $Opn$ proves $(\nu w)Q_{1}\{y/w\} \xrightarrow{xz} Q_{1}\{z/w\}$. $P_{1}\equiv_{\alpha}Q_{1}\{y/w\}$ imply $P_{1}\{z/y\} \equiv_{\alpha}Q_{1}\{y/w\}\{z/y\}$ which in turn imply $P_{1}\{z/y\} \equiv_{\alpha}Q_{1}\{z/w\}$.
% 	\item 
% 	  $P_{1}\{w/y\}\equiv_{\alpha}Q_{1}$: this case is similar.
% 	\end{itemize}
%       \item[Cls]:
...
% 		\\
% 		  \inferrule* [left=\bf{Opn}]{
% 		    R \xrightarrow{\overline{y}x} R^{'}
% 		  }{
% 		    (\nu x)R \xrightarrow{\overline{y}(x)} R^{'}
% 		  }
% 	      }{
% 		  (\nu x)P \xrightarrow{\overline{y}(x)} R^{'}
% 	      }$
% 	    \end{center}
% 	    which imply:
% 	    \begin{center}
...
% 			  R \xrightarrow{\overline{y}x} R^{'}
% 		      }{
% 			P \xrightarrow{\overline{y}x} R^{'}
% 		      }
% 		    \\
% 		      P \sim_{E} Q
% 		  }{
% 		    Q \xrightarrow{\overline{y}x} Q^{'}
% 		      \sim_{E} R^{'}
% 		      \stackrel{\overline{y}x}{\longleftarrow} P
% 		  }
% 		}{
% 		  (\nu x)Q  \xrightarrow{\overline{y}(x)} Q^{'}
% 			    \sim_{E} R^{'}
% 			    \stackrel{\overline{y}(x)}{\longleftarrow} (\nu x)P
% 		}$
% 	    \end{center}
% 	  \item[$Alp(2)$]:
% 	    \begin{center}
...
% 		    Q \xrightarrow{\gamma} Q^{'}
% 		      \sim_{E} R^{'}
% 		      \stackrel{\gamma}{\longleftarrow} P
% 		  }
% 		}{
% 		  (\nu x)Q  \xrightarrow{\gamma} (\nu x)Q^{'}
% 			    Res(\sim_{E}) (\nu x)R^{'}
% 			    \stackrel{\gamma}{\longleftarrow} (\nu x)P
% 		}$
% 	    \end{center}
%  	  \item[$Alp(3)$]:
%  	    for lemma \ref{multipiOutMoveAlpDown}:
%  	    \begin{center}
%  	      $\inferrule* [left=\bf{Alp}]{
%  		  \inferrule* {
%  		      P \equiv_{\alpha} R\{x/z\}
%  		    \\
%  		      z \notin n(R)
%  		  }{
%  		    (\nu x)P \equiv_{\alpha} (\nu z)R
...
%  		\\
%  		  \inferrule* [left=\bf{Opn}]{
%  		      R \stackrel{\overline{y}z}{\twoheadrightarrow} R^{'}
%  		  }{
%  		    (\nu z)R \stackrel{\overline{y}(z)}{\twoheadrightarrow} R^{'}
%  		  }
%  	      }{
%  		  (\nu x)P \xrightarrow{\overline{y}(z)} R^{'}
%  	      }$
%  	    \end{center}
%  	    which imply:
%  	    \begin{center}
...
%  			  R \stackrel{\overline{y}z}{\twoheadrightarrow} R^{'}
%  		      }{
%  			R\{x/z\} \xrightarrow{\overline{y}x} R^{''}
%  		      }
%  		  }{
%  		    P \xrightarrow{\overline{y}x} R^{''}
%  		  }
...
% 		\\
% 		  \inferrule* [left=\bf{Res}]{
% 		      R \stackrel{\gamma}{\twoheadrightarrow} R^{'}
% 		    \\
% 		      z \notin n(\gamma)
% 		  }{
% 		    (\nu z)R \stackrel{\gamma}{\twoheadrightarrow} (\nu z)R^{'}
% 		  }
% 	      }{
% 		  (\nu x)P \xrightarrow{\gamma} (\nu z)R^{'}
% 	      }$
...
% 			  z\notin n(R)
% 		      }{
% 			R\{x/z\} \xrightarrow{\gamma\{x/z\}} R^{''}
% 		      }
% 		  }{
% 		    P \xrightarrow{\gamma\{x/z\}} R^{''}
% 		  }
% 		  \\
% 		    P \sim_{E} Q
% 		}{
% 		  Q  \xrightarrow{\gamma\{x/z\}} Q^{'}
% 			    \sim_{E} R^{''}
% 			    \stackrel{\gamma\{x/z\}}{\longleftarrow} P
% 		}
% 		\\
% 		  x\notin n(\gamma\{x/z\})
% 		}{
% 		  (\nu x)Q  \xrightarrow{\gamma\{x/z\}} (\nu x)Q^{'}
% 			    Res(\sim_{E}) (\nu x)R^{''}
% 			    \stackrel{\gamma\{x/z\}}{\longleftarrow} (\nu x)P
% 		}$
% 	    \end{center}
	\end{description}
      \item[Parallel composition]
