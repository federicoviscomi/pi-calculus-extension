...
% \begin{lemma}[Inversion lemma for structural congruence]\label{inversionlemmamultiinplatewithh}
%   :\begin{description}
%     \item[$Output$]
...
\begin{lemma}\label{structuralCongruenceElimination}
  If $P\xrightarrow{\gamma}_{3} P^{'}$ then there exist processes $N,N^{'}$ such that $N$ is a normal form, $P\equiv N$, $P^{'} \equiv N^{'}$ and we can prove that $N\xrightarrow{\gamma}_{2} N^{'}$ without using the rules $Cls$ and $Alp$.
\end{lemma}
...
%     A \emph{strong bisimulation up to structural congruence} is a simmetric binary relation $\mathbf{S}$ on multi $\pi$ processes such that for all $P\mathbf{S}Q$:
%    \begin{itemize}
%      \item 
%        $P \xrightarrow{\alpha} P^{'}$, $bn(\alpha)$ is fresh and $\alpha$ is not an input nor a sequence of inputs then there exist processes $Q^{'}, Q^{''}, P^{''}$ such that $Q \xrightarrow{\alpha} Q^{'}$ and $P^{'} \mathbf{R} P^{''} \mathbf{S} Q^{''} \mathbf{R} Q^{'}$
%      \item
...
% 			}$
% 		\end{center}
% 		Since $P\sim_{L}Q$ we have $Q \xrightarrow{\gamma} Q^{'}$ and $P^{'} \sim_{L} Q^{'}$ or $P^{'}\{\tilde{w}/\tilde{y}\} \sim_{L} Q^{'}\{\tilde{w}/\tilde{y}\}$. For rule $Sum$: $Q+R \xrightarrow{\gamma} Q^{'}$
...
% 		      }$
% 		    \end{center}
% 		    $P \sim_{L} Q$ and $P \stackrel{\gamma}{\twoheadrightarrow} P^{''}$ imply $Q \xrightarrow{\gamma} Q^{''}$ and $P^{''} \sim_{L} Q^{''}$ or $P^{''}\{\tilde{w}/\tilde{y}\} \sim_{L} Q^{''}\{\tilde{w}/\tilde{y}\}$. For rules $Res$ and $Sum$: $Q+(\nu x)R \xrightarrow{\gamma} (\nu x)Q^{''}$.
% 		  \item[$Opn$]
% 		\end{description}
...
% 		  }$
% 		\end{center}
% 		$P_{1} \stackrel{\gamma}{\twoheadrightarrow} P^{'}$ imply $P=P_{1}+P_{2} \stackrel{\gamma}{\twoheadrightarrow} P^{'}$ so for bisimilarity $Q \xrightarrow{\gamma} Q^{'}$ and $P^{'}\sim_{L} Q^{'}$ or $P^{'}\{\tilde{w}/\tilde{y}\} \sim_{L} Q^{'}\{\tilde{w}/\tilde{y}\}$. For rule $Sum$: $Q+R \xrightarrow{\gamma} Q^{'}$.
...
% 		  }$
% 		\end{center}
% 		$P \stackrel{\gamma}{\twoheadrightarrow} P^{'}$ so for bisimilarity $Q \xrightarrow{\gamma} Q^{'}$ and $P^{'}\sim_{L} Q^{'}$ or $P^{'}\{\tilde{w}/\tilde{y}\} \sim_{L} Q^{'}\{\tilde{w}/\tilde{y}\}$. For rule $Sum$: $Q+R \xrightarrow{\gamma} Q^{'}$.
...
% 		$P \stackrel{\gamma}{\twoheadrightarrow} P^{'}$ so for bisimilarity $Q \xrightarrow{\gamma} Q^{'}$ and $P^{'}\sim_{L} Q^{'}$ or $P^{'}\{\tilde{w}/\tilde{y}\} \sim_{L} Q^{'}\{\tilde{w}/\tilde{y}\}$. For rule $Sum$: $Q+R \xrightarrow{\gamma} Q^{'}$.
	...
	\begin{description}
	  \item[$Res(1)$]
	    ...
	    \end{center}
	    $P \xrightarrow{\widetilde{x(y)}} P^{'}$ and $P\sim_{L}Q$ imply $Q \xrightarrow{\widetilde{x(y)}} Q^{'}$ and for all $\tilde{w}$: $P^{'}\{\tilde{w}/\tilde{y}\} \sim_{L} Q^{'}\{\tilde{w}/\tilde{y}\}$ which imply $(\nu z)(P^{'}\{\tilde{w}/\tilde{y}\}) Res(\sim_{L}) (\nu z)(Q^{'}\{\tilde{w}/\tilde{y}\})$. Under the hypothesis that $z\notin \tilde{w}$: $z \notin n(\widetilde{x(y)})$ imply $(\nu z)(P^{'}\{\tilde{w}/\tilde{y}\})=((\nu z) P^{'})\{\tilde{w}/\tilde{y}\}$. Nevertheless we have to prove that also for $z\in \tilde{w}$ and $z \notin n(\widetilde{x(y)})$: $((\nu z)P^{'})\{\tilde{w}/\tilde{y}\} Res(\sim_{L}) ((\nu z)Q^{'})\{\tilde{w}/\tilde{y}\}$.
	    COME ?!?!?!?!
	  \item[$Res(2)$]
	    ...
	    \end{center}
	    $P \xrightarrow{\gamma} P^{'}$ and $P\sim_{L}Q$ imply $Q \xrightarrow{\gamma} Q^{'}$ and $P^{'} \sim_{L} Q^{'}$ which in turn imply $(\nu z)P^{'} Res(\sim_{L}) (\nu z)Q^{'}$.
	  \item[$Opn$]
	    let $\tilde{y}$ be fresh in $P,Q$.
	    \begin{center}
	      $\inferrule* [left=\bf{Opn}]{
	    ...
	    \end{center}
	    $P \xrightarrow{\overline{x}y} P^{'}$ and $P\sim_{L}Q$ imply $Q \xrightarrow{\overline{x}y} Q^{'}$ and $P^{'} \sim_{L} Q^{'}$ which imply that $((\nu z)P^{'}, (\nu z)Q^{'})$ is in $Res(\sim_{L})$.
