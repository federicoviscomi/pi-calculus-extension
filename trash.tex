...
\end{theorem}
  ...
  \begin{proof}
	...
	\begin{description}
	  ...
	  \item[SumL] 
		...
		P_{1}+P_{2}\; \xrightarrow{\alpha}_{2}\; Q_{1}^{'}
	      }
	    \]
	    we move upward the rule $Alp$ like this:
	    \[
	    ...
	    \]
	    Now we can apply the inductive hypothesis to $P_{1}\; \xrightarrow{\alpha}_{2}\; Q_{1}^{'}$ and get $P_{1}\; \xrightarrow{\alpha}_{1}\; Q_{1}^{''}$ for some $Q_{1}^{''}\equiv_{\alpha} Q_{1}^{'}$. After this we apply the rule $SumL$ and get 
	    \[
	      P_{1}+P_{2}\; \xrightarrow{\alpha}_{1}\; Q_{1}^{''}
	    \]
	    The case for $SumR$ is simmetric and so omitted.
	  \item[ParL]
	    \[
	      \inferrule* [left=Alp]{
		  P_{1}|P_{2}\equiv_{\alpha}Q_{1}|Q_{2}
		...
		P_{1}|P_{2}\; \xrightarrow{\alpha}_{2}\; Q_{1}^{'}|Q_{2}
	      }
	    \]
	    this become
	    \[
	  ...
	  \item[ClsL]
	    ...
	    \[
		  ...
		  \inferrule* [left=Alp]{
		    ...
		    P_{1} \xrightarrow{\overline{x}(z)} Q_{1}^{'}
		  }
		\\
		  \inferrule* [left=Alp]{
		      P_{2}\equiv_{\alpha}Q_{2}
	  ...
	  \item[Cns]
		...
		\\
		  \inferrule* [left=Cns]{
		      A(\tilde{x}) \stackrel{def}{=} Q
		    \\
		      Q\{\tilde{y}/\tilde{x}\} \xrightarrow{\alpha} Q^{'}
		  }{
		    A(\tilde{y}) \xrightarrow{\alpha} Q^{'}
		  }
	      }{
		P \xrightarrow{\alpha} Q^{'}
	      }
	    \]
	    Given $P\equiv_{\alpha}A(\tilde{y})$ and $A(\tilde{x})=Q$ we create another identifier $B(\tilde{y})=P$ such that $A(\tilde{y})\equiv_{\alpha}B(\tilde{y})$ and replace the previous derivation with:
	    \[
	      \inferrule* [left=Cns]{
		  B(\tilde{y})\stackrel{def}{=}P
		\\
		  \inferrule* [left=Alp]{
		      B(\tilde{y})\equiv_{\alpha}Q\{\tilde{y}/\tilde{x}\}
		    \\
		      Q\{\tilde{y}/\tilde{x}\} \xrightarrow{\alpha} Q^{'}
		  }{
		    B(\tilde{y})\xrightarrow{\alpha} Q^{'}
		  }
	      }{
		P\xrightarrow{\alpha} Q^{'}
	      }
  ...
  \end{proof}
 		...
 		the proof proceed by cases on $S$:
 		\begin{description}
 		  \item[$AlpZero$]
 		\end{description}
