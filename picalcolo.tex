...
\begin{definition} \index{$bn$}
  ...
  \begin{center}
	...
	$B(\overline{x}y.Q, I)\; =\; B(Q, I)$
      \\\\
	$B(x(y).Q, I)\; =\; \{y\}\cup B(Q, I)$
      \\\\
	$B(\tau.Q, I)\; =\; B(Q, I)$
      \\\\
	$B(A(x_{1},\cdots, x_{n}), I)=\left\{
	  \begin{array}{ll}
		\{x_{1},\cdots, x_{n}\}\cup B(Q, I\cup \{A\})
	      &
	...
	$B(Q|R,I)\; =\; B(Q,I)\cup B(R,I)$
      \\\\
	$B((\nu a)Q, I)\; =\; \{a, \overline{a}\}\cup B(Q, I)$
    \end{tabular}
  \end{center}
\end{definition}
...
\begin{definition} \index{name occurrence! free}
  ...
  \begin{center}
	...
	$F(0, I)\; =\; \emptyset$
      \\\\
	$F(\overline{x}y.Q, I)\; =\; \{x,y\}\cup F(Q, I)$
      \\\\
	$F(x(y).Q, I)\; =\; (\{x\}\cup F(Q, I))-\{y,\overline{y}\}$
      \\\\
	$F(\tau.Q, I)\; =\; F(Q, I)$
      \\\\
...
%Metterci una semantica osservazionale (bisimulazione early e open) ed un po’ di proprietà algebriche (congruenza).
