...
\[
  \rightarrow_{L}
\]
for the late semantic. % with $\alpha$ conversion but without structural congruence.
It's not a concern which late semantic we are talking about because we have proved them equivalent.

\begin{definition}
  A \emph{strong late ground simulation}(according to \cite{milnerparrowwalker}) is a binary relation $\mathbf{S}$ on processes such that for each process $P$ and $Q$, $P\mathbf{S}Q$ implies:
  \begin{itemize}
    \item 
      if $P \xrightarrow{\alpha}_{L} P^{'}$ and $\alpha$ is $\tau$ or a free output then there exists a process $Q^{'}$ such that $Q \xrightarrow{\alpha}_{L} Q^{'}$ and $P^{'}\mathbf{S}Q^{'}$
    \item
      if $P \xrightarrow{x(y)}_{L} P^{'}$ and $y\notin n(P)\cup n(Q)$ then there exists a process $Q^{'}$ such that $Q \xrightarrow{x(y)}_{L} Q^{'}$ and for all $w$ $P^{'}\{w/y\}\mathbf{S}Q^{'}\{w/y\}$
    \item
      if $P \xrightarrow{\overline{x}(y)}_{L} P^{'}$ and $y\notin n(P)\cup n(Q)$ then there exists a process $Q^{'}$ such that $Q \xrightarrow{\overline{x}(y)}_{L} Q^{'}$
  \end{itemize}
\end{definition}


\begin{definition}
  A \emph{strong late ground bisimulation} is a binary relation $\mathbf{S}$ on processes such that both $\mathbf{S}$ and its inverse are strong late ground simulations. $P$ and $Q$ are \emph{late ground bisimilar} written $P\dot{\sim}_{L}Q$ if there exists a strong ground late bisimulation $\mathbf{S}$ such that $P\mathbf{S}Q$.
\end{definition}
...
\begin{example}
  Strong late ground bisimulation is not closed under substitution in general:
  \[
...
\begin{definition}\index{bisimulation! strong! early! with early semantic}
  A \emph{strong early ground bisimulation}(according to \cite{milnerparrowwalker})is a symmetric binary relation $\mathbf{S}$ on processes such that for each $P,Q$ $P\mathbf{S} Q$ implies that
  \begin{itemize}
    \item 
      if $P \xrightarrow{\alpha}_{L} P^{'}$ with $\alpha \neq x(y)$ and $bn(\alpha)\notin fn(P) \cup fn(Q)$ then there exists $Q^{'}$ such that $Q \xrightarrow{\alpha}_{L} Q^{'}$ and $P^{'}\mathbf{S}Q^{'}$ 
    \item
      if $P \xrightarrow{x(y)}_{L} P^{'}$ with $y\notin fn(P) \cup fn(Q)$ then for each $w$ there exists $Q^{'}$ such that $Q \xrightarrow{x(y)}_{L} Q^{'}$ and $P^{'}\{w/y\}\mathbf{S}Q^{'}\{w/y\}$ 
    \item
      if $P \xrightarrow{\overline{x}(y)}_{L} P^{'}$ and $y\notin n(P)\cup n(Q)$ then there exists a process $Q^{'}$ such that $Q \xrightarrow{\overline{x}(L)}_{E} Q^{'}$
  \end{itemize}
  $P$ and $Q$ are \emph{early ground bisimilar} written $P\dot{\sim}_{E}Q$ if there exists a strong ground early bisimulation $\mathbf{S}$ such that $P\mathbf{S}Q$
\end{definition}
