...
\begin{lemma}
  ...
  \begin{proof}
	...
	\begin{center}
	  \begin{tabular}{ll}
	    $fn(\tau.P)=fn(P)$&definition of $fn$\\
	    $=fn(Q)$&inductive hypothesis\\
	    $=fn(\tau.Q)$&definition of $fn$\\
	  \end{tabular}
	\end{center}
      \item[$AlpOut$]:
	\begin{center}
	...
	\begin{center}
	  \begin{tabular}{ll}
	    ...
	    $\Rightarrow fn(P)-\{x\}=(fn(Q)-\{y\}\cap \{x\})-\{x\}$&\\
	...
	\begin{center}
	  \begin{tabular}{ll}
	    ...
	    $\Rightarrow fn(P_{1})\cap fn(P_{2})=fn(Q_{1})\cap fn(Q_{2})$&definition of $fn$\\
