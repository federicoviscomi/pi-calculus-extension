...
% 	    $\Rightarrow fn(Q_{1}\{b/a\})\cup \{x,y\}=((fn(Q_{1})-\{a\})\cup \{b\})\cup \{x,y\}$ & $x, y, a, b$ pairwise disjoint\\
...
\begin{lemma}
  ...
  \begin{proof}
	...
	\begin{center}
	  \begin{tabular}{ll}
	    $fn(P)=fn(Q)$&inductive hypothesis\\
	    $\Rightarrow fn(\tau.P)=fn(\tau.Q)$&definition of $fn$\\
	  \end{tabular}
	\end{center}
      \item[$AlpOut$]:
	\begin{center}
	  \begin{tabular}{ll}
	    $fn(P)=fn(Q)$&inductive hypothesis\\
	    $\Rightarrow fn(P)\cup \{x,y\}=fn(Q)\cup \{x,y\}$&\\
	    $\Rightarrow fn(\overline{x}y.P)=fn(\overline{x}y.Q)$&definition of $fn$\\
	  \end{tabular}
	\end{center}
      \item[$AlpRes1$]:
	\begin{center}
	  \begin{tabular}{ll}
	    $fn(P)=fn(Q\{x/y\})$&inductive hypothesis\\
	    $\Rightarrow fn(P)-\{x\}=fn(Q\{x/y\})-\{x\}$&lemma \ref{freenamesandsubstitution}\\
	...
	\begin{center}
	  \begin{tabular}{ll}
	    $fn(P_{1})=fn(Q_{1})\; and\; fn(P_{2})=fn(Q_{2})$&inductive hypothesis\\
	...
	\begin{center}
	  \begin{tabular}{ll}
	    $fn(P)=fn(Q)$&inductive hypothesis\\
	    $\Rightarrow fn(P)- \{x\}=fn(Q)- \{x\}$&\\
	    $\Rightarrow fn((\nu x)P)=fn((\nu x)Q)$&definition of $fn$\\
	  \end{tabular}
	\end{center}
      \item[$AlpInp$]:
	\begin{center}
	  \begin{tabular}{ll}
	    $fn(P)=fn(Q)$&inductive hypothesis\\
	    $\Rightarrow (fn(P)-\{y\})\cup \{x\}=(fn(Q)-\{y\})\cup \{x\}$&\\
	    $\Rightarrow fn(x(y).P)=fn(x(y).Q)$&definition of $fn$\\
	  \end{tabular}
	\end{center}
      \item[$AlpIde$]
	the lemma holds because $P$ and $Q$ are the same process.
...
\begin{lemma}
  ...
  \begin{proof}
    The proof goes by induction on the length of the proof tree of $P\equiv_{\alpha}Q$ and then by cases on the last rule of the proof tree:
    \begin{description}
      \item[base case]:
	\begin{description}
	  \item[$AlpZerp, AlpIde$]
	    the lemma holds because $P$ and $Q$ are syntacticly the same process.
	\end{description}
      \item[inductive case]:
	\begin{description}
	  \item[$AlpTau$]:
	  ...
	  \item[$AlpOut$]:
	    ...
	    \end{center}
	  \item[$AlpInp$]
	    where $y$ $a$ and $b$ are pairwise disjoint. 
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}$&inductive hypothesis\\
		$\Rightarrow P_{1}\{b/a\}\equiv_{\alpha}Q_{1}\{b/a\}$&rule $AlpIn$\\
		$\Rightarrow x\{b/a\}(y).P_{1}\{b/a\}\equiv_{\alpha}x\{b/a\}(y).Q_{1}\{b/a\} $&definition of substitution\\
		...
		$\Rightarrow x\{b/a\}(a).P_{1}\equiv_{\alpha}x\{b/a\}(a).Q_{1} $&definition of substitution\\
		$\Rightarrow (x(a).P_{1})\{b/a\}\equiv_{\alpha}(x(a).Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}$&inductive hypothesis\\
		$\Rightarrow P_{1}\{c/b\}\equiv_{\alpha}Q_{1}\{c/b\}$&inductive hypothesis\\
		$\Rightarrow P_{1}\{c/b\}\{b/a\}\equiv_{\alpha}Q_{1}\{c/b\}\{b/a\} $&rule $AlpIn$\\
		$\Rightarrow x\{b/a\}(c).(P_{1}\{c/b\}\{b/a\})\equiv_{\alpha}x\{b/a\}(c).(Q_{1}\{c/b\}\{b/a\}) $&definition of substitution\\
		$\Rightarrow (x(b).P_{1})\{b/a\}\equiv_{\alpha}(x(b).Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    
	  \item[$AlpInp1$]:
		...
		y\in fn(Q)
	      ...
	      \underbrace{z(x).P_{1}}_{P}\equiv_{\alpha}\underbrace{z(y).Q_{1}}_{Q}
	    }\]

	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}\{x/y\}$&inductive hypothesis\\
		$\Rightarrow P_{1}\{b/a\}\equiv_{\alpha}Q_{1}\{x/y\}\{b/a\}$&DA DIMOSTARE\\
		$\Rightarrow P_{1}\{b/a\}\equiv_{\alpha}Q_{1}\{b/a\}\{x/y\}$&rule $AlpInp1$\\
		$\Rightarrow z\{b/a\}(x).(P_{1}\{b/a\})\equiv_{\alpha}z\{b/a\}(y).(Q_{1}\{b/a\}) $&definition of substitution\\
		...
		$?$&\\
		$\Rightarrow P_{1}\equiv_{\alpha}Q_{1}\{b/a\}\{a/y\}$&\\
		$\Rightarrow z\{b/a\}(a).P_{1}\equiv_{\alpha}z\{b/a\}(y).(Q_{1}\{b/a\}) $&definition of substitution\\
		$\Rightarrow (z(a).P_{1})\{b/a\}\equiv_{\alpha}(z(y).Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}\{b/y\}$&inductive hypothesis\\
		$?$&\\
		$\Rightarrow P_{1}\{c/b\}\{b/a\}\equiv_{\alpha}Q_{1}\{b/a\}\{c/y\} $&rule $AlpInp1$\\
		$\Rightarrow z\{b/a\}(c).(P_{1}\{c/b\}\{b/a\})\equiv_{\alpha}z\{b/a\}(y).(Q_{1}\{b/a\}) $&definition of substitution\\
		$\Rightarrow (z(b).P_{1})\{b/a\}\equiv_{\alpha}(z(y).Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}\{b/a\}$&inductive hypothesis\\
		$?$&\\
		$\Rightarrow P_{1}\{c/b\}\{b/a\}\equiv_{\alpha}Q_{1}\{c/a\} $&rule $AlpInp1$\\
		$\Rightarrow z\{b/a\}(c).P_{1}\{c/b\}\{b/a\}\equiv_{\alpha}z\{b/a\}(a).Q_{1} $&\\
		$\Rightarrow (z(b).P_{1})\{b/a\}\equiv_{\alpha}(z(a).Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}\{x/a\}$&inductive hypothesis\\
		$?$&\\
		$\Rightarrow P_{1}\{b/a\}\equiv_{\alpha}Q_{1}\{x/a\} $&rule $AlpInp1$\\
		$\Rightarrow z\{b/a\}(x).P_{1}\{b/a\}\equiv_{\alpha}z\{b/a\}(a).Q_{1} $&definition of substitution\\
		$\Rightarrow (z(x).P_{1})\{b/a\}\equiv_{\alpha}(z(a).Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}\{x/b\}$&inductive hypothesis\\
		$?$&\\
		$\Rightarrow P_{1}\{b/a\}\equiv_{\alpha}Q_{1}\{c/b\}\{b/a\}\{x/b\} $&rule $AlpInp1$\\
		$\Rightarrow z\{b/a\}(x).P_{1}\{b/a\}\equiv_{\alpha}z\{b/a\}(b).Q_{1}\{c/b\}\{b/a\} $&definition of substitution\\
		$\Rightarrow (z(x).P_{1})\{b/a\}\equiv_{\alpha}(z(b).Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}\{a/b\}$&inductive hypothesis\\
		$?$&\\
		$\Rightarrow P_{1}\equiv_{\alpha}Q_{1}\{c/b\}\{b/a\}\{a/b\} $&rule $AlpInp1$\\
		$\Rightarrow z\{b/a\}(a).P_{1}\equiv_{\alpha}z\{b/a\}(b).Q_{1}\{c/b\}\{b/a\} $&definition of substitution\\
		$\Rightarrow (z(a).P_{1})\{b/a\}\equiv_{\alpha}(z(b).Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    

	  \item[$AlpRes$]:
	    where $x, a$ and $b$ are pairwise disjoint. 
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}$&inductive hypothesis\\
	    ...
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}$&rule $AlpRes$\\
		$\Rightarrow (\nu a)P_{1}\equiv_{\alpha}(\nu a)Q_{1} $&definition of substitution\\
		$\Rightarrow ((\nu a)P_{1})\{b/a\}\equiv_{\alpha}((\nu a)Q_{1})\{b/a\} $&\\
	      \end{tabular}
	    \end{center}	    	    
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}$&inductive hypothesis\\
		$P_{1}\{c/b\}\equiv_{\alpha}Q_{1}\{c/b\}$&inductive hypothesis\\
		$\Rightarrow P_{1}\{c/b\}\{b/a\}\equiv_{\alpha}Q_{1}\{c/b\}\{b/a\}$&rule $AlpRes$\\
		$\Rightarrow (\nu c)(P_{1}\{c/b\}\{b/a\})\equiv_{\alpha}(\nu c)(Q_{1}\{c/b\}\{b/a\}) $&definition of substitution\\
