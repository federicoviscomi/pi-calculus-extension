...
% 			  \begin{tabular}{lll}
% 			  $y\notin n(P)$&&\\
% 			  $z\notin n(\alpha)$&$\Rightarrow$&$P\{y/z\}\xrightarrow{\alpha}_{3}Q\{y/z\}$\\
% 			  $P\xrightarrow{\alpha}_{3}Q$&&\\
% 			  \end{tabular}
			  $y\notin n(P)$ and 
			  $z\notin n(\alpha)$ and 
	  ...
	  \end{tabular}
		  \item[Str] 
		    we can assume we do not have two consecutive application of the rule $Str$ because if we had those, we could use the transitivity of the structural congruence to merge them.
		\end{description}
	    \end{itemize}	    
	\end{description}
    \end{description}
