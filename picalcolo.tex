  ...
  \begin{proof}
	...
	\begin{description}
	  \item[$y\notin fn(Q)$]:
		...
		$\Rightarrow fn(P)=fn(Q\{x/y\})$&$y\notin fn(Q)$ and def of substitution\\
		$\Rightarrow fn(P)=fn(Q)$&$x\notin fn(Q)$\\
		$\Rightarrow fn(P)=fn(Q)\; and\; x\notin fn(P)$&\\
	      \end{tabular}
	    \end{center}
  ...
  \begin{proof}:
	...
	\begin{description}
	  ...
	  \item[$AlpOut$]:
	    ...
	    \end{center}
	  \item[$AlpInp$]
	    where $y$ $a$ and $b$ are pairwise different. 
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}$&inductive hypothesis\\
	    ...
	    \end{center}	    	    
	  \item[$AlpInp1$]:
	    Let $x,y,z,a$ and $b$ be pairwise different, then we have various cases:
	    \begin{itemize}
	      \item 
...
% 	    $AlpZero$ $AlpIde$ or $AlpRef$
	  ...
	  \item[$AlpRes$]:
	    where $x, a$ and $b$ are pairwise different. 
	    \begin{center}
	      \begin{tabular}{ll}
		&rule premise\\
		$P_{1}\equiv_{\alpha}Q_{1}$&inductive hypothesis\\
	    ...
	    \end{center}	    	    
	  \item[$AlpRes1$]:
	    Since $a$ is in the free names of both $P$ and $Q$ then $a$ cannot be in the restriction at the top level of $P$ or $Q$. So let $x,y,b$ and $a$ be pairwise different. We have three different cases:
