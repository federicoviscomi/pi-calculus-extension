...
\begin{lemma}{\emph{inversion lemma}}
  ...
  \begin{itemize}
    ...
    \item
      If $P\equiv_{\alpha} x(y).Q$ then $P=x(z).P_{1}$ for some $P_{1}$ such that $P_{1}\{z/y\}\equiv_{\alpha}Q$
    \item
...
Here we write $\rightarrow_{1}$ for the early semantic without structural congruence, $\rightarrow_{2}$ for the early semantic with just $\alpha$ conversion and $\rightarrow_{3}$ for the early semantic with the full structural congruence. 
We would like to prove that $P\xrightarrow{\alpha}_{1}P^{'}\; \Leftrightarrow\; P\xrightarrow{\alpha}_{2}P^{'}$ but this is false because
\[
  \inferrule* [left=Alp]{
